...
The v0.5.0 MVP stores manual trips, vehicle labels, job/client labels, and categories in private Android app storage and writes CSV or JSON backup files only when the user taps a share/export action.
